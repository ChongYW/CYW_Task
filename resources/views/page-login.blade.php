									...
									<div class="card-body">
										...
										<div class="tab-content w-100" id="nav-tabContent">
										  <div class="tab-pane fade show active" id="nav-personal" role="tabpanel" aria-labelledby="nav-personal-tab">
											<form class=" dz-form pb-3" method="POST" action="{{ route('login') }}">
                                                @csrf
...
<!--														<input name="dzName" required="" class="form-control " placeholder="Type Password" type="password">-->
                                                        <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="Type Password" name="password" required autocomplete="current-password">
													...
													<div class="form-group text-left mb-5">
														<button type="submit" class="btn btn-primary dz-xs-flex m-r5">{{ __('Login') }}</button>
												...
												<div class="text-center bottom">
                                                    <a href="{{ url('page-register') }}">
                                                        <button class="btn btn-primary button-md btn-block" id="nav-sign-tab" data-bs-toggle="tab" type="button" role="tab">Create an account</button>
                                                    </a>
